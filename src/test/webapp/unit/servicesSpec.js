...
describe('services', function() {
  ...
  describe('CurrentState services tests', function() {
    it('setSearchFilter should update chirps', inject(function(CurrentState, $timeout) {
      ...
      $timeout(function() { expect(CurrentState.getUserChirps().length).toBe(1);});
      CurrentState.setSearchFilter("china");
      $timeout(function() { expect(CurrentState.getUserChirps().length).toBe(2);});
    }));
  ...
  describe('ChirpHelper service tests', function() {
    it('recent chirps returns nothing', inject(function(ChirpHelper){
        var recent = ChirpHelper.recentChirps([{id: 2, created_at:"Fri May 24 13:14:12 2011"}, {id: 1, created_at:"Fri May 24 13:10:12 2011"}, {id: 3, created_at:"Fri May 24 16:15:12 2011"}], 2);
        expect(recent.length).toBe(0);
    }));

    it('recent chirps returns some', inject(function(ChirpHelper){
      var currentDate = new Date().toGMTString();
      var recent = ChirpHelper.recentChirps([{id: 2, created_at:currentDate}, {id: 1, created_at:"Fri May 24 13:10:12 2011"}, {id: 3, created_at:"Fri May 24 16:15:12 2011"}], 2);
    ...
    it('merging equal size lists', inject(function(ChirpHelper) {
      var mergedList = ChirpHelper.mergeChirps([{id: 1, created_at:"Fri May 24 13:17:12 2013"}, {id: 4, created_at:"Fri May 24 13:14:12 2013"}], [{id: 2, created_at:"Fri May 24 13:16:12 2013"}, {id: 3, created_at:"Fri May 24 13:15:12 2013"}]);
    ...
    it('merging bigger left list', inject(function(ChirpHelper) {
      var mergedList = ChirpHelper.mergeChirps([{id: 2, created_at:"Fri May 24 13:17:12 2013"}, {id: 3, created_at:"Fri May 24 13:14:12 2013"}], [{id: 1, created_at:"Fri May 24 13:18:12 2013"}]);
    ...
    it('merging bigger right list', inject(function(ChirpHelper) {
      var mergedList = ChirpHelper.mergeChirps([{id: 2, created_at:"Fri May 24 13:14:12 2013"}], [{id: 1, created_at:"Fri May 24 16:15:12 2013"}, {id: 3, created_at:"Fri May 24 13:10:12 2013"}]);
      expect(mergedList.length).toBe(3);
      var expectedIndex = 1;
      for(var i = 0; i < mergedList.length; i++) {
        expect(mergedList[i].id).toBe(expectedIndex);
